...
import br.com.nailson.cursomc.dto.CategoriaDTO;
import br.com.nailson.cursomc.services.PedidoService;
...
public class PedidoResource {
	...
	public ResponseEntity<Page<Pedido>> findPage(
		...
		Page<Pedido> list = service.findPages(page, linePerPage, direction, orderBy);
